...
let missingBackenModules: MissingBackenModules[] = [];
...
function getInstallAndRequiredModules(requiredBackendModules) {
  ...
  let installedAndRequiredBackendModules = installedBackendModules.filter(
    module => {
...
console.log(misMatchingBackendModules);
export { missingBackenModules, misMatchingBackendModules };
